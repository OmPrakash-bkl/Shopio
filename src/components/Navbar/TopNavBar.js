...
function TopNavBar() {
  ...
  <a href="#" className="mx-2 text-light"><i class="fa fa-facebook-f"></i></a>
  <a href="#" className="mx-2 text-light"><i class="fa fa-envelope"></i></a>
  <a href="#" className="mx-2 text-light"><i class="fa fa-whatsapp"></i></a>
  </div>
